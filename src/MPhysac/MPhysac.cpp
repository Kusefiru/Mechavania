...
#include "MPhysac/MPhysac.hpp"

// Returns the cross product of a vector and a value
Vector2f MPhysac::MathCross(float value, const Vector2f& vector) {
    return Vector2f(-value*vector.y, value*vector.x);
}

// Returns the cross product of two vectors
float MPhysac::MathCrossVector2(const Vector2f& v1, const Vector2f& v2) {
    return (v1.x*v2.y - v1.y*v2.x);
}

// Returns the len square root of a vector
float MPhysac::MathLenSqr(const Vector2f& vector) {
    return (vector.x*vector.x + vector.y*vector.y);
}

// Returns the dot product of two vectors
float MPhysac::MathDot(const Vector2f& v1, const Vector2f& v2) {
    return (v1.x*v2.x + v1.y*v2.y);
}

// Returns the square root of distance between two vectors
float MPhysac::DistSqr(const Vector2f& v1, const Vector2f& v2) {
    Vector2f dir = v1 - v2;
...
Matrix2x2 MPhysac::Mat2Transpose(const Matrix2x2& matrix) {
    return { matrix.m00, matrix.m10, matrix.m01, matrix.m11 };
}

// Multiplies a vector by a matrix 2x2
Vector2f MPhysac::Mat2MultiplyVector2(const Matrix2x2& matrix, const Vector2f& vector) {
